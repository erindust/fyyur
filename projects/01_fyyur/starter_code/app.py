...
def show_venue(venue_id):
  ...
  print("FUNCTION show_venue: gathering data")
  data = {
    "id": venue.id,
    "name": venue.name,
    "genres": venue.genres,
...
def edit_artist_submission(artist_id):
  ...
  if error:
    print("ERROR: ARTIST COULD NOT BE CHANGED")
...
def edit_venue_submission(venue_id):
  ...
  if error:
    flash(f'An error occurred while editing this venue.')
...
def create_show_submission():
  ...
  try:
    ...
    print("shows/create:",request.form)
